...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/homepage.css?v=<?php time(); ?>">
        <!-- TITLE PAGE -->
        <title>Website Desa Karangnongko Poncokusumo - Tambah Mahasiswa KKN</title>
        <script>
        ...
        <div class="container pt-5">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form enctype="multipart/form-data" action="<?php echo base_url('simpanModeRahasia'); ?>" method="post">
                                <div class="form-group row mb-2">
                                    <label for="namaKKN" class="col-sm-2 col-form-label">Nama</label>
                                    <div class="col-sm-10">
                                        <input type="hidden" class="form-control" id="gambarKKN" name="gambarKKN" required value="<?= set_value('gambarKKN'); ?>">
                                        <input type="text" class="form-control" id="namaKKN" name="namaKKN" required value="<?= set_value('namaKKN'); ?>">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="jabatanKKN" name="jabatanKKN" required value="<?= set_value('jabatanKKN'); ?>">
                                        <small class="text-danger">
