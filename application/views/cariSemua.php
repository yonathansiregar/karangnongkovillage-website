          ...
          foreach ($cari_berita as $row) : ?>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card-body" style="border-style: solid; border-width: 1px; border-radius: 20px; border-color: #909A9B;">
                <img src="<?php echo base_url(); ?>assets/images/news/<?= $row->gambarBerita; ?>" height="250px" class="card-img-top p-2 myImages" style=" width: 350; height: 175; margin-left: auto; margin-right: auto;" alt="Card Image">
                <!-- The Modal -->
      ...
      foreach ($cari_umkm as $row) : ?>
        <section class="my-5 products-list d-flex justify-content-center align-items-center">
          <div class="card horizontal-card mb-3" style="width: 1295px; background-color: transparent;">
            <div class="row g-0">
              <div class="col-md-4">
                <img id="umkm-image" src="<?php echo base_url(); ?>assets/images/umkm-products/<?= $row->gambarUmkm ?>" class="img-fluid p-5 rounded-start myImages" style=" width: 280; height: 328;" alt="Foto Produk UMKM">
              </div>
              <div class="col-md-8">
                    ...
                    <table>
                      <tr>
                        <td colspan="3" style="height:50px ; ">
                          <p class="card-title" id="umkm-name" style="font-size:20px ;"><b><?= $row->namaUmkm ?></b></p>
                        </td>
                      </tr>
              ...
              <div class="col-12 col-lg-6">
                <div class="card mb-3">
                  <div class="row no-gutters">
                    <div class="col-md-4">
                      <img src="<?php echo base_url(); ?>assets/images/village-profile/<?= $row->gambarPD ?>" class="card-img myImages" style="aspect-ratio: 86 / 107;" alt="...">
                    </div>
                    <div class="col-md-8">
