...
?>
    ...
    <head>
        ...
        <script>
            ...
            function getoutput() {
                gambarBerita.value = ("0" + today.getDate()).slice(-2)+'-'+("0" + (today.getMonth() + 1)).slice(-2)+'-'+today.getFullYear()+' '+("0" + today.getHours()).slice(-2) + ":" + ("0" + today.getMinutes()).slice(-2) + ":" + ("0" + today.getSeconds()).slice(-2)+' '+getFile(gambar.value);
        ...
        <div class="container pt-5">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form enctype="multipart/form-data" action="<?php echo base_url('simpanEditBerita/' . $pilih_berita->idBerita); ?>" method="post">
