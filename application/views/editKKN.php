...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/homepage.css?v=<?php time(); ?>">
        <!-- TITLE PAGE -->
        <title>Website Desa Karangnongko Poncokusumo - Edit Mahasiswa KKN</title>
        <script>
            ...
            function getoutput() {
                gambarKKN.value = getFile(gambar.value);
        ...
        <div class="container pt-5">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form enctype="multipart/form-data" action="<?php echo base_url('simpanEditModeRahasia/' . $pilih_KKN->idKKN); ?>" method="post">
                                <div class="form-group row mb-2">
                                    <label for="namaKKN" class="col-sm-2 col-form-label">Nama</label>
                                    <div class="col-sm-10">
                                        <input type="hidden" class="form-control" id="idKKN" name="idKKN" required value="<?= $pilih_KKN->idKKN; ?>">
                                        <input type="hidden" class="form-control" id="gambarKKN" name="gambarKKN" required value="<?= $pilih_KKN->gambarKKN; ?>">
                                        <input type="text" class="form-control" id="namaKKN" name="namaKKN" required value="<?= $pilih_KKN->namaKKN; ?>">
                                        <small class="text-danger">
                                            <?php echo form_error('namaKKN') ?>
                                        </small>
                                    </div>
                                </div>

                                <div class="form-group row mb-2">
                                    <label for="jabatanKKN" class="col-sm-2 col-form-label">Jabatan</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="jabatanKKN" name="jabatanKKN" required value="<?= $pilih_KKN->jabatanKKN; ?>">
                                        <small class="text-danger">
                                            <?php echo form_error('jabatanKKN') ?>
                                        </small>
                                    </div>
                                </div>
