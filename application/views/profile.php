  ...
  <main>
    ...
    <section id="structural">
      <div class="d-flex justify-content-center">
        <img class="my-5 img-fluid myImages" src="<?php echo base_url(); ?>assets/images/village-profile/jabatan-strukturaldesa.png" alt="Jabatan Struktural Desa">
      </div>
      <!-- The Modal -->
    ...
    <section id="community-service-program">
      ...
      <div class="container fs-5" style="margin-top: 80px; margin-bottom: 80px;" id="college-student">
        <div class="row g-4">
          <?php foreach ($data_kkn as $row) : ?>
            <div class="col-12 col-lg-6">
              <div class="card mb-3" style="border: 1px solid #000; border-radius: 10px;">
                <div class="row no-gutters">
                  <div class="col-md-4">
                    <img src="<?php echo base_url(); ?>assets/images/village-profile/<?= $row->gambarKKN ?>" class="card-img myImages" style="aspect-ratio: 86 / 107;" alt="<?= $row->namaKKN; ?>">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body" style="padding: 75px 0px 0px 25px;">
