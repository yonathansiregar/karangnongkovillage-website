...
<body>
  ...
  <main>
    ...
    <section id="community-service-program">
      ...
      <div class="container block fs-5" style="margin-top: 80px; margin-bottom: 80px;" id="college-student">
        <div class="row g-4">
          <?php foreach ($data_kkn as $row) : ?>
            <div class="col-12 col-lg-6">
              <div class="card mb-3" style="border-radius: 20px;">
                <div class="row no-gutters">
                  <div class="col-md-4">
                    <img src="<?php echo base_url(); ?>assets/images/village-profile/<?= $row->gambarKKN ?>" class="card-img" style="aspect-ratio: 86 / 107; border-radius: 20px 20px 0px 0px ;" alt="<?= $row->namaKKN; ?>">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body" style="padding: 75px 0px 0px 25px;">
